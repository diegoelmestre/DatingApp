...
var AlertifyService = /** @class */ (function () {
    ...
    AlertifyService.prototype.sucess = function (message) {
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService
            ...
            _this.alertify.sucess("You have liked: " + _this.user.knownAs);
        }, function (error) {
            _this.alertify.error(error);
        });
    };
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
            _this.alertify.sucess('Profile updated successfully');
        ...
        this.userService
            ...
            for (var i = 0; i < messages.length; i++) {
                ...
                if (element.isRead === false && element.recipientId === currentUserId) {
                    _this.userService.markAsRead(currentUserId, element.id);
                }
            }
        }))
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this photo?', function () {
            _this.userService
                ...
                _this.alertify.sucess('Photo has been deleted');
            }, function (error) {
                _this.alertify.error(error);
            });
        });
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this message?', function () {
            ...
            _this.userService
                ...
                _this.alertify.sucess('Message has been deleted');
            }, function (error) {
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            _this.alertify.sucess('Logged in Sucessfully');
        }, function (error) {
            _this.alertify.error(error);
        }, function () {
            _this.router.navigate(['/members']);
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.alertify.sucess('Registration sucessful');
            }, function (error) {
                _this.alertify.error(error);
            }, function () {
...
module.exports = __webpack_require__(/*! C:\Users\apalm\Documents\Courses\1_NetCore_Angular\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
